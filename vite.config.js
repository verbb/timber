...
export default ({ command }) => ({
    ...
    build: {
        ...
        rollupOptions: {
            input: {
                timber: '/utility/src/js/timber.js',
            },
        },
    },
    ...
    plugins: [
        ...
        EslintPlugin({
            ...
            exclude: './src/web/assets/utility/src/js/vendor/**/*.{js,vue}',
        }),
    ...
    resolve: {
        alias: {
            ...
            '@': path.resolve('./src/web/assets/utility/src'),

            // Allow us to use `@utils/` in JS for misc utilities.
            '@utils': path.resolve('./src/web/assets/utility/src/js/utils'),

            // Allow us to use `@components/` in Vue components.
            '@components': path.resolve('./src/web/assets/utility/src/components'),
